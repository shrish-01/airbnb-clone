        ...
        <div className="mx-auto max-w-7xl">
          <form className="bg-white shadow-md rounded-3xl px-8 pt-6 pb-8 mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button className="bg-primary text-white px-4 grow rounded-2xl">Add&nbsp;Photo</button>
            </div>
            ...
            <p className="text-sm text-gray-500">Describe your place. (Pro Tip?, Make it sound magnificent)</p>
            <textarea />
            {/* Perks */}
            ...
            <h2 className="text-xl mt-4">More Info</h2>
            <p className="text-sm text-gray-500">Whatever more you think off!</p>
            <textarea />

            <h2 className="text-xl mt-4">Check-in & out.</h2>
            <p className="text-sm text-gray-500">User, should not miss!</p>
            <div className="grid gap-2 sm:grid-cols-3">
              <div>
                <h3 className="mt-2 -mb-1">Check-in time</h3>
                <input type="text" placeholder="10:00 AM (Format)" />
              </div>
              <div>
